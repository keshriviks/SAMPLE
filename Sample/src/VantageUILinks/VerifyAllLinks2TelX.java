...
public class VerifyAllLinks2TelX extends TestBase {
...
System.out.println(link_pf .getText());
System.out.println(link_pf .getAttribute("href"));
...
public void logoutApplication() throws InterruptedException{
	...
	@Test(enabled= false)
	public void policyAllLinks(){
		WebDriver driver= new FirefoxDriver();
        driver.manage().window().maximize();
        driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
        driver.manage().timeouts().pageLoadTimeout(60, TimeUnit.SECONDS);
        //driver.get("https://192.168.116.151:8443/ima/login.do");
        driver.get("https://72.37.143.42:8443/ima/login.do");
        //https://72.37.143.42:8443/ima
        // setting the username 
        WebElement username=driver.findElement(By.xpath(".//input[@name='username']"));
        username.sendKeys("mspadmin");
