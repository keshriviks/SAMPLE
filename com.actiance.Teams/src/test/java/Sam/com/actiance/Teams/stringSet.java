...
public class stringSet {
	...
	public String getmixed1()throws FileNotFoundException{
        String content = new Scanner(new File("D:\\Automation code\\Teams\\Links\\ALLMIXED1.txt")).useDelimiter("\\Z").next();
	...
	public String getAllMixed(){
		...
		return "Normal Bold 1 http://www.wordtracker.com/academy/seo-clean-urls " ;
	}
